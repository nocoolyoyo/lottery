...
<img align="center" width="100%" src="./preview1.png">

2.在特等奖之前会开启补抽功能，补抽的轮数和人数备注如下所示

<img align="center" width="100%" src="./preview4.png">

3.点击记录可以查看已抽中的人员名单，点击导出可导出excel文件到本地

<img align="center" width="100%" src="./preview5.png">

4.点击重置会重置所有的抽奖数据，由于抽奖数据是记录到本地的，所以要重置必须通过此按钮才能重置抽奖数据

<img align="center" width="100%" src="./preview3.png">
